...
exports.accountDeleteEmailTemplate = void 0;
const accountDeleteEmailTemplate = (otp, firstName) => `
  <html>
    <head>
      <style>
    ...
    <body>
      ...
      <p style="color: #333333;">We have received a request to delete your account.</p>
      <p style="color: #333333;">Please use the following OTP to delete your account:</p>
...
`;
exports.accountDeleteEmailTemplate = accountDeleteEmailTemplate;
