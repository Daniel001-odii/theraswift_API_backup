...
exports.htmlMailClinicCodeTemplate = void 0;
const htmlMailClinicCodeTemplate = (otp, firstName) => `
  <html>
    <head>
      <style>
    ...
    <body>
      ...
      <p style="color: #333333;">We have received a request to give you clinic code.</p>
      <p style="color: #333333;">Please use the following code as your clinic code:</p>
...
`;
exports.htmlMailClinicCodeTemplate = htmlMailClinicCodeTemplate;
